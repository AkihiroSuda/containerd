...
// Deduplication is just done for potential caching purpose and unaware of the scope grammar.
// e.g. appendScopes([]string{"repository:foo/bar:pull,push"}, "repository:foo/bar:push,pull") returns a semantically duplicated slice.
// See https://docs.docker.com/registry/spec/auth/scope/ for the scope grammar.
