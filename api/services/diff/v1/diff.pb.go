...
type ApplyResponse struct {
	...
	// warnings is available only when ApplyRequest.continue_on_error was true.
	Warnings []*ApplyWarning `protobuf:"bytes,2,rep,name=warnings" json:"warnings,omitempty"`
}
...
func (m *ApplyWarning) Reset()                    { *m = ApplyWarning{} }
func (*ApplyWarning) ProtoMessage()               {}
func (*ApplyWarning) Descriptor() ([]byte, []int) { return fileDescriptorDiff, []int{2} }
...
func init() {
	...
	proto.RegisterType((*ApplyWarning)(nil), "containerd.services.diff.v1.ApplyWarning")
...
func (m *ApplyWarning) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ApplyWarning) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.Warning) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintDiff(dAtA, i, uint64(len(m.Warning)))
...
func (m *ApplyWarning) Size() (n int) {
	var l int
	_ = l
	l = len(m.Path)
	if l > 0 {
...
func (this *ApplyResponse) String() string {
	...
	s := strings.Join([]string{`&ApplyResponse{`,
		...
		`Warnings:` + strings.Replace(fmt.Sprintf("%v", this.Warnings), "ApplyWarning", "ApplyWarning", 1) + `,`,
		`}`,
	}, "")
	return s
}
func (this *ApplyWarning) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&ApplyWarning{`,
...
func (m *ApplyResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Warnings = append(m.Warnings, &ApplyWarning{})
...
func (m *ApplyWarning) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ApplyWarning: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ApplyWarning: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorDiff = []byte{
	...
	,
}
